...
# I extract every double-digit (testdata only contain double-digit integers)
# and save each height and width together in sublists.
...
for ntest in range(Ntest):
    # Due to my testdata-format I had to loop to correctly extract the widths and heights.
    if ntest == 0:
...
print("Again with Five-nearest-method and your input sample:")
...
#     Total = total number of attempts = len(testdata)
#
